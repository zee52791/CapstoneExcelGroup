...
sex_fig.update_layout(title="Per Capita Income Average for the Different Education Attainment Levels for Males and Females",
                xaxis_title="Identified Sex", yaxis_title="Per Capita Income Average", legend=dict(title="Education Level"))
...
race_fig.update_layout(title="Per Capita Income for the Different Education Attainment Levels by Identified Race",
                xaxis_title="Identified Race", yaxis_title="Per Capita Income Average", legend=dict(title="Education Level"))
...
fig = px.line(degree_employment_status, x="Year", y="Unemployment rate", 
                title = 'Comparison of Unemployment Rates for the Different Educational Attainment Levels Through the Years',
...
houseincome.update_layout(title="Average Household Income by State Compared to the United States",
                  xaxis_title="Average Household Income", yaxis_title="State", showlegend = False)
...
income_allyears_fig.update_layout(title="Per Capita Income for The Identified Race", xaxis_title="Identified Race", yaxis_title="Per Capita Income Average")
...
houseincome_fig.update_layout(barmode="group")
...
def render_page_content(pathname):
    if pathname == "/":
        ...
        return html.H2("Does household income correlate to educational attainment?"),dcc.Graph(id='household-income-fig',figure= houseincome_fig)
        ...
        figure={
            ...
            'layout': go.Layout(
                title='Per Capita Income for the Different Education Attainment Levels through 2010 - 2019',
                xaxis={'title': 'Year'},
                yaxis={'title': 'Per Capita Income Average'},
                barmode='group'
            )}), dcc.Graph( id='income_year_graph',
        figure={
            'data': [
            ...
            'layout': go.Layout(
                title="Estimated Average Income for 2015-2019 in the US",
                xaxis = {
                    "tickmode" : 'array',
